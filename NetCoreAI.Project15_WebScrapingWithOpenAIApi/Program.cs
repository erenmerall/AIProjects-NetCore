...
class Program
{
    //! Web scraping, bir programın veya botun, bir web sayfasındaki bilgileri (örneğin ürün fiyatları, 
    //! haber başlıkları, yorumlar vb.) otomatik şekilde çekip kendi veritabanına ya da dosyasına kaydetmesidir.
